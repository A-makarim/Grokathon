...
/**
 * Job complexity level (determines xAI eligibility)
 */
...
export interface Job {
  ...
  assignedTo: string | null; // applicant ID or 'xai'
...
/**
 * Input for creating an applicant
 */
...
/**
 * Filters for listing applicants
 */
...
export interface Application {
  ...
  profileSummary: string | null; // generated by Profile Agent
  bidAmount: number | null; // applicant's bid/price for the job
  appliedAt: string;
  status: ApplicationStatus;
  applicant?: Applicant; // joined data
}
...
/**
 * AI-generated hiring suggestion
 */
export interface Suggestion {
  ...
  createdAt: string;
  applicant?: Applicant; // joined data if human suggested
}
...
/**
 * Filters for listing suggestions
 */
...
/**
 * Work output generated by xAI Agent
 */
