...
export function BountyGrid({ bounties, hasMore, onLoadMore }: BountyGridProps) {
      ...
      {[...Array(6)].map((_, i) => (
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-8 bg-[#16181C] rounded-full animate-pulse" />
            <div className="h-4 bg-[#16181C] rounded w-32 animate-pulse" />
          </div>
          ...
          <div className="flex justify-between">
            <div className="h-5 bg-[#16181C] rounded w-24 animate-pulse" />
