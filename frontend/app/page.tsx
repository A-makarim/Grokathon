      ...
      <section className="py-24 border-t border-[#2F3336]">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 border-t border-l border-[#2F3336]">
            {[
              { name: 'Development', count: openBounties.filter(b => b.category === 'Development').length },
              { name: 'Design', count: openBounties.filter(b => b.category === 'Design').length },
              { name: 'Writing', count: openBounties.filter(b => b.category === 'Writing').length },
              { name: 'Marketing', count: openBounties.filter(b => b.category === 'Marketing').length },
              { name: 'Research', count: openBounties.filter(b => b.category === 'Research').length },
              { name: 'Other', count: openBounties.filter(b => b.category === 'Other').length },
            ].map((category) => (
              <Link 
                key={category.name}
